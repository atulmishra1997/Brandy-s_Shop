...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_sHy8MZoU2xO9yb",
      key_secret: "fH5pROmO0fAetoti0aP9q73T",
  ...
  return (
    <Layout >
      <div className="bg-gray-100 pt-5 pb-[100%]" style={{height:"300vh" ,backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
            ...
            {cartItems.map((item, index) => {
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                <div className="mt-5 sm:mt-0">
                  ...
                  <p className="mt-1 text-lg font-semibold text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>₹{price}</p>
                </div>
